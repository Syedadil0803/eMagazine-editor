...
const schema = Yup.object().shape({
  toEmail: Yup.string().email('Unvalid magazine').required('Magazine required'),
});
      ...
      >
        {({ handleSubmit }) => (
          <Modal
            ...
            onCancel={closeModal}
          >
            <TextField autoFocus name='toEmail' label='To magazine' />
            <TextAreaField
              rows={15}
              autoFocus
              name='mergeTags'
